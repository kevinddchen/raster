...
public:
    ...
    const Eigen::Vector3d& v1() const { return _v1; };
    const Eigen::Vector3d& v2() const { return _v2; };
    const Eigen::Vector3d& v3() const { return _v3; };

    Eigen::Vector3d& mut_v1() { return _v1; };
    Eigen::Vector3d& mut_v2() { return _v2; };
    Eigen::Vector3d& mut_v3() { return _v3; };
